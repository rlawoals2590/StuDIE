...
Revision ID: c8e6a0982ab1
Revises: 4dd1f010baaf
Create Date: 2023-07-21 19:34:57.601336
...
revision = 'c8e6a0982ab1'
down_revision = '4dd1f010baaf'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('point', schema=None) as batch_op:
        ...
        batch_op.create_unique_constraint('point', ['stid', 'school'])
...
def downgrade():
    ...
    with op.batch_alter_table('point', schema=None) as batch_op:
        ...
        batch_op.drop_constraint('point', type_='unique')
